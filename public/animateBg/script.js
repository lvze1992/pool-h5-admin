...
window.bgAnimateFunc = bgAnimateFunc;
function bgAnimateFunc() {
  try {
    ...
    window.bgAnimate = function () {
      ...
      introTimeline.add([TweenLite.to(skyContainer, 2, { opacity: 0.8, ease: Power3.easeInOut })]);
    };

    window.bgCancelAnimate = function () {
